#!/usr/bin/env python3
"""
Landsat Scene Query Tool - M2M API Implementation
Direct REST API implementation for USGS Machine-to-Machine (M2M) API.
"""
...
class LandsatSceneQueryM2M:
    ...
    def __init__(self, username: Optional[str] = None, password: Optional[str] = None):
        ...
        self.api = LandsatM2MAPI(username, password)
...
def main():
    ...
    query = LandsatSceneQueryM2M(username, password)
